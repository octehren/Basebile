function instantiateBall(centerX, positionY, finalPositionY, screenWidth)
	...
	ball.successfulHit = function(self)
		...
		transition.to( self, { y = 0, x = ballX, time = math.random(300, 600), tag = "ballMovement", xScale = ballScale, yScale = ballScale, rotation = math.random(360, 1080), onComplete = function(ball) ball.isVisible = false; self.xScale = 1; self.yScale = 1; end });
	end
